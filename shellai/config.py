...
DEFAULTS: dict = {
    ...
    "model_tiny": "qwen3.5:0.8b",   # ultra-fast, trivial single-step queries
    "model_fast": "qwen3.5:2b",     # standard queries
    "model_strong": "qwen3.5:4b",   # complex / multi-step queries
...
class Config:
    ...
    model_tiny: str = DEFAULTS["model_tiny"]
